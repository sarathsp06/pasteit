...
func NewPasterProtobufClient(addr string, client HTTPClient, opts ...twirp.ClientOption) Paster {
...
func NewPasterJSONClient(addr string, client HTTPClient, opts ...twirp.ClientOption) Paster {
	if c, ok := client.(*http.Client); ok {
		client = withoutRedirects(c)
	}
...
func NewPasterServer(svc Paster, hooks *twirp.ServerHooks) TwirpServer {
	return &pasterServer{
		Paster: svc,
		hooks:  hooks,
	}
...
// PasterPathPrefix is used for all URL paths on a twirp Paster server.
// Requests are always: POST PasterPathPrefix/method
...
var twirpFileDescriptor0 = []byte{
	...
	,
}
