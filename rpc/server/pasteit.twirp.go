...
// NewPasterProtobufClient creates a Protobuf client that implements the Paster interface.
...
func NewPasterProtobufClient(baseURL string, client HTTPClient, opts ...twirp.ClientOption) Paster {
	...
	serviceURL += baseServicePath(pathPrefix, "pasteit", "Paster")
	urls := [2]string{
		serviceURL + "CreatePaste",
		serviceURL + "GetPaste",
	}
...
func (c *pasterProtobufClient) CreatePaste(ctx context.Context, in *CreatePasteRequest) (*CreatePasteResponse, error) {
	...
	caller := c.callCreatePaste
	if c.interceptor != nil {
		caller = func(ctx context.Context, req *CreatePasteRequest) (*CreatePasteResponse, error) {
			resp, err := c.interceptor(
				func(ctx context.Context, req interface{}) (interface{}, error) {
					typedReq, ok := req.(*CreatePasteRequest)
					if !ok {
						return nil, twirp.InternalError("failed type assertion req.(*CreatePasteRequest) when calling interceptor")
					}
					return c.callCreatePaste(ctx, typedReq)
				},
			)(ctx, req)
			if resp != nil {
				typedResp, ok := resp.(*CreatePasteResponse)
				if !ok {
					return nil, twirp.InternalError("failed type assertion resp.(*CreatePasteResponse) when calling interceptor")
				}
...
func (c *pasterProtobufClient) callCreatePaste(ctx context.Context, in *CreatePasteRequest) (*CreatePasteResponse, error) {
...
func (c *pasterProtobufClient) GetPaste(ctx context.Context, in *GetPasteRequest) (*GetPasteResponse, error) {
	...
	caller := c.callGetPaste
	if c.interceptor != nil {
		caller = func(ctx context.Context, req *GetPasteRequest) (*GetPasteResponse, error) {
			resp, err := c.interceptor(
				func(ctx context.Context, req interface{}) (interface{}, error) {
					typedReq, ok := req.(*GetPasteRequest)
					if !ok {
						return nil, twirp.InternalError("failed type assertion req.(*GetPasteRequest) when calling interceptor")
					}
					return c.callGetPaste(ctx, typedReq)
				},
			)(ctx, req)
			if resp != nil {
				typedResp, ok := resp.(*GetPasteResponse)
				if !ok {
					return nil, twirp.InternalError("failed type assertion resp.(*GetPasteResponse) when calling interceptor")
				}
				return typedResp, err
			}
			return nil, err
...
func (c *pasterProtobufClient) callGetPaste(ctx context.Context, in *GetPasteRequest) (*GetPasteResponse, error) {
...
// NewPasterJSONClient creates a JSON client that implements the Paster interface.
...
func (c *pasterJSONClient) callCreatePaste(ctx context.Context, in *CreatePasteRequest) (*CreatePasteResponse, error) {
	out := new(CreatePasteResponse)
...
func (c *pasterJSONClient) callGetPaste(ctx context.Context, in *GetPasteRequest) (*GetPasteResponse, error) {
	out := new(GetPasteResponse)
...
// =====================
// Paster Server Handler
// =====================

type pasterServer struct {
	Paster
	interceptor      twirp.Interceptor
...
// NewPasterServer builds a TwirpServer that can be used as an http.Handler to handle
...
func (s *pasterServer) writeError(ctx context.Context, resp http.ResponseWriter, err error) {
	writeError(ctx, resp, err, s.hooks)
}

// handleRequestBodyError is used to handle error when the twirp server cannot read request
func (s *pasterServer) handleRequestBodyError(ctx context.Context, resp http.ResponseWriter, msg string, err error) {
...
// PasterPathPrefix is a convenience constant that may identify URL paths.
// Should be used with caution, it only matches routes generated by Twirp Go clients,
// with the default "/twirp" prefix and default CamelCase service and method names.
// More info: https://twitchtv.github.io/twirp/docs/routing.html
const PasterPathPrefix = "/twirp/pasteit.Paster/"

func (s *pasterServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	ctx := req.Context()
	ctx = ctxsetters.WithPackageName(ctx, "pasteit")
	ctx = ctxsetters.WithServiceName(ctx, "Paster")
...
func (s *pasterServer) serveCreatePasteJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	...
	handler := s.Paster.CreatePaste
	if s.interceptor != nil {
		handler = func(ctx context.Context, req *CreatePasteRequest) (*CreatePasteResponse, error) {
			resp, err := s.interceptor(
				func(ctx context.Context, req interface{}) (interface{}, error) {
					...
					return s.Paster.CreatePaste(ctx, typedReq)
				},
			)(ctx, req)
			if resp != nil {
				typedResp, ok := resp.(*CreatePasteResponse)
...
func (s *pasterServer) serveGetPasteJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	...
	handler := s.Paster.GetPaste
	if s.interceptor != nil {
		handler = func(ctx context.Context, req *GetPasteRequest) (*GetPasteResponse, error) {
			resp, err := s.interceptor(
				func(ctx context.Context, req interface{}) (interface{}, error) {
					typedReq, ok := req.(*GetPasteRequest)
					if !ok {
					...
					return s.Paster.GetPaste(ctx, typedReq)
				},
			)(ctx, req)
			if resp != nil {
				typedResp, ok := resp.(*GetPasteResponse)
...
func (s *pasterServer) ServiceDescriptor() ([]byte, int) {
	return twirpFileDescriptor0, 0
}

func (s *pasterServer) ProtocGenTwirpVersion() string {
	return "v8.1.2"
}
...
func (s *pasterServer) PathPrefix() string {
	return baseServicePath(s.pathPrefix, "pasteit", "Paster")
}
